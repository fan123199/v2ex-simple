...
public class CircleVImageView extends NetworkImageView {
    ...
    public CircleVImageView(Context context) {
        super(context);

        init();
    }

    public CircleVImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleVImageView(Context context, AttributeSet attrs, int defStyle) {
