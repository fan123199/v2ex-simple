...
public class CookiesSerializable implements Serializable {
    private static final String TAG = CookiesSerializable.class.getSimpleName();
    ...
    public Cookie decode(String encodedCookie) {
        ...
        try {
            ...
            cookie = ((CookiesSerializable) objectInputStream.readObject()).cookie;
        } catch (IOException e) {
